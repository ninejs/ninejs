...
export default (function(window: any) {
	...
	var Modernizr: ModernizerType = (function(window: Window, document: HTMLDocument) {

		var version = '2.6.2',

			Modernizr: any = function(tst: string): any {
		...
		var docElement = document.documentElement,
			...
			inputElem: any = document.createElement('input'),
			...
			injectElementWithStyles = function(rule: any, callback: any, nodes?: any, testnames?: any) {

				var style: any, ret: any, node: any, docOverflow: any,
			...
			testMediaQuery = function(mq: any) {
				...
				injectElementWithStyles('@media ' + mq + ' { #' + mod + ' { position: absolute; } }', function(node: any) {
			...
			isEventSupported = (function() {
				...
				function isEventSupported(eventName: any, element: any) {
		...
		if (!is(_hasOwnProperty, 'undefined') && !is(_hasOwnProperty.call, 'undefined')) {
			hasOwnProp = function(object: any, property: any) {
...
//							var F = function() {};
		...
		function setCss(str: string) {
			mStyle.cssText = str;
		}

		function setCssAll(str1: string, str2?: string) {
		...
		function testProps(props: any, prefixed?: string) {
			for (var i in props) {
				var prop = props[i];
		...
		function testDOMProps(props: any, obj: any, elem: any) {
			for (var i in props) {
		...
		function testPropsAll(prop: any, prefixed?: any, elem?: any): any {
		...
		tests['touch'] = function() {
			...
			if (('ontouchstart' in _window) || (typeof(DocumentTouch) !== 'undefined') && (DocumentTouch) && document instanceof DocumentTouch) {
				...
				injectElementWithStyles(['@media (', prefixes.join('touch-enabled),('), mod, ')', '{#modernizr{top:9px;position:absolute}}'].join(''), function(node: any) {
		...
		tests['csstransforms3d'] = function() {
			...
			if (ret && 'webkitPerspective' in docElement.style) {
				...
				injectElementWithStyles('@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}', function(node: any, rule: any) {
		...
		tests['fontface'] = function() {
			...
			injectElementWithStyles('@font-face {font-family:"font";src:url("https://")}', function(node: any, rule: any) {
				var style: any = document.getElementById('smodernizr'),
		...
		tests['generatedcontent'] = function() {
			...
			injectElementWithStyles(['#', mod, '{font:0/0 a}#', mod, ':after{content:"', smile, '";visibility:hidden;font:3px/1 a}'].join(''), function(node: any) {
		...
		function webforms() {
			Modernizr['input'] = (function(props: any) {
			...
			Modernizr['inputtypes'] = (function(props: any) {

				for (var i = 0, bool: boolean, inputElemType: any, defaultView: any, len = props.length; i < len; i++) {
		...
		Modernizr.addTest = function(feature: any, test: any) {
		...
		(function(window: any, document: any) {
			...
			var supportsUnknownElements: any;
			...
			function addStyleSheet(ownerDocument: any, cssText: any) {
			...
			function getExpandoData(ownerDocument: any) {
			...
			function createElement(nodeName: any, ownerDocument: any, data: any) {
				if (!ownerDocument) {
			...
			function createDocumentFragment(ownerDocument: any, data: any) {
				if (!ownerDocument) {
					ownerDocument = document;
				}
				if (supportsUnknownElements) {
			...
			function shivMethods(ownerDocument: any, data: any) {
				if (!data.cache) {
					data.cache = {};
				...
				ownerDocument.createElement = function(nodeName: any) {
				...
				ownerDocument.createDocumentFragment = Function('h,f', 'return function(){' +
						...
						'h.shivMethods&&(' +
						getElements().join().replace(/\w+/g, function(nodeName: any) {
			...
			function shivDocument(ownerDocument: any) {
				if (!ownerDocument) {
					ownerDocument = document;
				}
		...
		Modernizr.testProp = function(prop: any): any {
		...
		Modernizr.prefixed = function(prop: any, obj: any, elem: any) {
			if (!obj) {
	...
	(function(a: any, b: any, c?: any) {
		...
		function i(a: any, c: any, d: any, e: any, f: any, i: any, j: any) {
			function k(b: any) {
		...
		function j(a: any, b: any, c: any, d: any, f: any) {
		...
		var l = b.documentElement,
			...
			t = s ? l : n.parentNode,
			l2 = a.opera && "[object Opera]" == o.call(a.opera),
			l3 = !!b.attachEvent && !l2,
		...
		B = function(a: any) {
			...
			function g(a: any, e: any, f: any, g: any, h?: any) {
				var i = b(a),
					j = i.autoCallback;
			...
			var i: any, j: any, l: any = this.yepnope.loader;
			if (e(a)) g(a, 0, l, 0);
			else if (w(a))
				for (i = 0; i < a.length; i++) j = a[i], e(j) ? g(j, 0, l, 0) : w(j) ? B(j) : Object(j) === j && h(j, l);
			else Object(a) === a && h(a, l)
		}, B.addPrefix = function(a: any, b: any) {
			z[a] = b
		}, B.addFilter = function(a: any) {
			x.push(a)
		}, B.errorTimeout = 1e4, null == b.readyState && b.addEventListener && (b.readyState = "loading", b.addEventListener("DOMContentLoaded", A = function() {
			b.removeEventListener("DOMContentLoaded", A, 0), b.readyState = "complete"
		}, 0)), a.yepnope = k(), a.yepnope.executeStack = h, a.yepnope.injectJs = function(a: any, c: any, d: any, e: any, i: any, j: any) {
			var k = b.createElement("script"),
				l: any, o: any, e = e || B.errorTimeout;
			k.src = a;
		...
		}, a.yepnope.injectCss = function(a: any, c: any, d: any, e: any, g: any, i: any) {
	...
	(function() {
		...
		function getBgRepeatValue(elem: any) {
		...
		Modernizr.testStyles(' #modernizr { background-repeat: round; } ', function(elem: any, rule: any) {
		...
		Modernizr.testStyles(' #modernizr { background-repeat: space; } ', function(elem: any, rule: any) {
	...
	Modernizr.testStyles('#modernizr{background-size:cover}', function(elem: any) {
	...
	Modernizr.addTest('bgpositionxy', function() {
		return Modernizr.testStyles('#modernizr {background-position: 3px 5px;}', function(elem: any) {
	...
	Modernizr.testStyles(' #modernizr { display: run-in; } ', function(elem: any, rule: any) {
	...
	(function() {
		...
		function test_hyphens(delimiter: any, testWidth: any) {
			try {
				/* create a div container and a span within that
				 * these have to be appended to document.body, otherwise some browsers can give false negative */
				var div = document.createElement('div'),
		...
		function test_hyphens_find(delimiter: any) {
			try {
	...
	Modernizr.addTest('lastchild', function() {
		...
		return Modernizr.testStyles("#modernizr div {width:100px} #modernizr :last-child{width:200px;display:block}", function(elem: any) {
	...
	Modernizr.addTest('cssscrollbar', function() {
		...
		Modernizr.testStyles(styles, function(node: any) {
	...
	Modernizr.addTest('subpixelfont', function() {
		...
		Modernizr.testStyles(styles, function(elem: any) {
	...
	Modernizr.addTest('cssvhunit', function() {
		var bool: boolean;
		Modernizr.testStyles("#modernizr { height: 50vh; }", function(elem: any, rule: any) {
			var height = _window.parseInt(_window.innerHeight / 2, 10),
	...
	Modernizr.addTest('cssvmaxunit', function() {
		var bool: boolean;
		Modernizr.testStyles("#modernizr { width: 50vmax; }", function(elem: any, rule: any) {
	...
	Modernizr.addTest('cssvminunit', function() {
		var bool: boolean;
		Modernizr.testStyles("#modernizr { width: 50vmin; }", function(elem: any, rule: any) {
			var one_vw = window.innerWidth / 100,
				one_vh = window.innerHeight / 100,
				compWidth = parseInt((window.getComputedStyle ?
					getComputedStyle(elem, null) :
	...
	Modernizr.addTest('cssvwunit', function() {
		var bool: boolean;
		Modernizr.testStyles("#modernizr { width: 50vw; }", function(elem: any, rule: any) {
			var width = _window.parseInt(_window.innerWidth / 2, 10),
				compStyle = parseInt((window.getComputedStyle ?
					getComputedStyle(elem, null) :
					elem.currentStyle)["width"], 10);
	...
	Modernizr.addTest('dataset', function() {
		var n: any = document.createElement("div");
	...
	Modernizr.addTest('details', function() {
		var doc = document,
			el: any = doc.createElement('details'),
			fake: any,
			root: any,
			diff: any;
	...
	Modernizr.addTest('ruby', function() {
		...
		function getStyle(element: any, styleProperty: any) {
			var result: any;
	...
	//
	(function(document: any, Modernizr: any) {
		...
		Modernizr.addTest('formvalidation', function() {
			...
			input.oninvalid = function(e: any) {
				invaildFired = true;
				e.preventDefault();
				e.stopPropagation();
			};
	...
	Modernizr.addTest('unicode', function() {
		...
		Modernizr.testStyles('#modernizr{font-family:Arial,sans;font-size:300em;}', function(node: any) {
	...
	(function() {
		...
		var canvas: any, ctx: any, exts: any;
	...
	(function() {
		try {
			...
			var BlobBuilder = _window.MozBlobBuilder || _window.WebKitBlobBuilder || _window.MSBlobBuilder || _window.OBlobBuilder || _window.BlobBuilder,
				URL = window.URL || _window.MozURL || _window.webkitURL || _window.MSURL || _window.OURL;
