...
var XMLP: any = function(strXML: string) {
...
XMLP.prototype.continueParsing = function(strXML: any) {
...
XMLP.prototype._addAttribute = function(name: any, value: any) {
    this.m_atts[this.m_atts.length] = new Array(name, value);
}

XMLP.prototype._checkStructure = function(iEvent: any) {
...
XMLP.prototype._findAttributeIndex = function(name: any) {
...
XMLP.prototype.getAttributeName = function(index: any) {
    return ((index < 0) || (index >= this.m_atts.length)) ? null : this.m_atts[index][XMLP._ATT_NAME];
}

XMLP.prototype.getAttributeValue = function(index: any) {
    return ((index < 0) || (index >= this.m_atts.length)) ? null : __unescapeString(this.m_atts[index][XMLP._ATT_VAL]);
}

XMLP.prototype.getAttributeValueByName = function(name: any) {
...
XMLP.prototype._parse = function() {
    ...
    function _indexOf(needle: any, haystack: any, start: any) {
...
////////// NAMESPACE SUPPORT //////////////////////////////////////////
XMLP.prototype._parsePrefixAndElementName = function (elementlabel: string){
    var splits = elementlabel.split(':',2);
    return { prefix : ((splits.length === 1) ? '' : splits[0]), name : ((splits.length === 1) ? elementlabel : splits[1]) };
}

XMLP.prototype._parseNamespacesAndAtts = function (atts: any[]){
   ...
   //The function should return a new list of tag attributes with the namespaces filtered
    var that = this;
    var newnamespaces: any[] = [];
    var filteredatts: any[] = [];
    atts.map(function (item: any){
...
XMLP.prototype._getContextualNamespace = function (prefix: string) {
...
XMLP.prototype._parseAttribute = function(iB: any, iE: any) {
    var iNB: any, iNE: any, iEq: any, iVB: any, iVE: any;
    var cQuote: any, strN: any, strV: any, iRet: any;
...
XMLP.prototype._parseCDATA = function(iB: any) {
    var iE: any = this.m_xml.indexOf("]]>", iB);
    if (iE == -1) {
...
XMLP.prototype._parseComment = function(iB: any) {
...
XMLP.prototype._parseDTD = function(iB: any) {
    // Eat DTD
    var iE: any, strClose: any, iInt: any, iLast: any;
...
XMLP.prototype._parseElement = function(iB: any) {
    var iE: any, iDE: any, iNE: any, iRet: any;
    var iType: any, strN: any, iLast: any;
...
XMLP.prototype._parseEntity = function(iB: any) {
    var iE = this.m_xml.indexOf(";", iB);
    if(iE == -1) {
        //This item never closes, although it could be a malformed document, we will assume that we are mid-chunck, save the string and reurn as interrupted
        this.m_chunkTransitionContinuation = this.m_xml.slice(iB-1);//the '-1' adds the '&' back into the string
...
XMLP.prototype._parsePI = function(iB: any) {
    var iE: any, iTB: any, iTE: any, iCB: any, iCE: any;
...
XMLP.prototype._parseText = function(iB: any) {
    var iE: any, ch: any;
...
XMLP.prototype._replaceEntities = function(strD: any, iB: any, iE: any) {
    if(SAXStrings.isEmpty(strD)) return "";
    iB = iB || 0;
    iE = iE || strD.length;


    var iEB: any, iEE: any, strRet = "", iRet: any;
...
XMLP.prototype._replaceEntity = function(strD: any, iB: any, iE: any) {
...
XMLP.prototype._setContent = function(iSrc: any) {
    var args = arguments;
...
XMLP.prototype._setErr = function(iErr: any) {
...
//with XML for <SCRIPT>
export var SaxParser: any = function(eventhandlerfactory: any) {

    var eventhandler: any = Object.create({});// new function(){

    //}

    class thehandler {
		onStartDocument = function (funct:any) {
			eventhandler.onStartDocument = funct;
		}
		onEndDocument = function (funct:any) {
			eventhandler.onEndDocument = funct;
		}
		onStartElementNS = function (funct:any) {
			eventhandler.onStartElementNS = funct;
		}
		onEndElementNS = function (funct:any) {
			eventhandler.onEndElementNS = funct;
		}
		onCharacters = function (funct:any) {
			eventhandler.onCharacters = funct;
		}
		onCdata = function (funct:any) {
			eventhandler.onCdata = funct;
		}
		onComment = function (funct:any) {
			eventhandler.onComment = funct;
		}
		onWarning = function (funct:any) {
			eventhandler.onWarning = funct;
		}

		onError = function (funct:any) {
...
SaxParser.prototype.parseFile = function(filename: any) { //This function will only work in the node.js environment.
    var that = this;
...
SaxParser.prototype.parseString = function(strD: any) {
    var that = this;
    var startnew = true;
    if(!that.m_parser){
...
SaxParser.prototype.setDocumentHandler = function(hnd: any) {
    this.m_hndDoc = hnd;
}

SaxParser.prototype.setErrorHandler = function(hnd: any) {
    this.m_hndErr = hnd;
}

SaxParser.prototype.setLexicalHandler = function(hnd: any) {
    this.m_hndLex = hnd;
}
...
SaxParser.prototype.getPublicId = function(): string {
    return null;
}

SaxParser.prototype.getSystemId = function(): string {
    return null;
}
...
SaxParser.prototype.getName = function(index: any) {
    return this.m_parser.getAttributeName(index);
}

SaxParser.prototype.getValue = function(index: any) {
    return this.m_parser.getAttributeValue(index);
}

SaxParser.prototype.getValueByName = function(name: any) {
    return this.m_parser.getAttributeValueByName(name);
}

SaxParser.prototype._fireError = function(strMsg: any) {
...
SaxParser.prototype._fireEvent = function(iEvt: any) {
    var hnd: any, func: any, args = arguments, iLen = args.length - 1;
...
SaxParser.prototype._parseLoop = function(parser: any) {
    var iEvent: any, parser: any,
		nameobject: any,
		theatts: any,
		theattsandnamespace: any;
...
SAXStrings.getColumnNumber = function(strD: any, iP: any) {
...
SAXStrings.getLineNumber = function(strD: any, iP: any) {
    if(SAXStrings.isEmpty(strD)) {
        return -1;
    }
    iP = iP || strD.length;
...
SAXStrings.indexOfNonWhitespace = function(strD: any, iB: any, iE: any) {
    if(SAXStrings.isEmpty(strD)) {
        return -1;
    }
    iB = iB || 0;
...
SAXStrings.indexOfWhitespace = function(strD: any, iB: any, iE: any) {
    if(SAXStrings.isEmpty(strD)) {
        return -1;
    }
    iB = iB || 0;
...
SAXStrings.isEmpty = function(strD: any) {
    return (strD == null) || (strD.length == 0);
}

SAXStrings.lastIndexOfNonWhitespace = function(strD: any, iB: any, iE: any) {
    if(SAXStrings.isEmpty(strD)) {
        return -1;
    }
    iB = iB || 0;
...
SAXStrings.replace = function(strD: any, iB: any, iE: any, strF: any, strR: any) {
    if(SAXStrings.isEmpty(strD)) {
        return "";
    }
    iB = iB || 0;
...
function trim(trimString: string, leftTrim: boolean, rightTrim: boolean) {
...
function __escapeString(str: string) {
...
function __unescapeString(str: string) {
