(function (factory) {
    ...
    XMLP.prototype._getContextualNamespace = function (prefix) {
        var len = this.m_namespaceStack.length, cnt, len2, cnt2, i, item;
        if (prefix !== '') {
    ...
    XMLP.prototype._removeExpiredNamespaces = function () {
    ...
    exports.SaxParser = function (eventhandlerfactory) {
        ...
        var thehandler = (function () {
            function thehandler() {
                ...
                this.onEndDocument = function (funct) {
                    eventhandler.onEndDocument = funct;
                };
                this.onStartElementNS = function (funct) {
                    eventhandler.onStartElementNS = funct;
                };
                this.onEndElementNS = function (funct) {
                    eventhandler.onEndElementNS = funct;
                };
                this.onCharacters = function (funct) {
                    eventhandler.onCharacters = funct;
                };
                this.onCdata = function (funct) {
                    eventhandler.onCdata = funct;
                };
                this.onComment = function (funct) {
                    eventhandler.onComment = funct;
                };
                this.onWarning = function (funct) {
    ...
    exports.SaxParser.DOC_B = 1;
    exports.SaxParser.DOC_E = 2;
    exports.SaxParser.ELM_B = 3;
    exports.SaxParser.ELM_E = 4;
    exports.SaxParser.CHARS = 5;
    exports.SaxParser.PI = 6;
    exports.SaxParser.CD_B = 7;
    exports.SaxParser.CD_E = 8;
    exports.SaxParser.CMNT = 9;
    exports.SaxParser.DTD_B = 10;
    exports.SaxParser.DTD_E = 11;
    exports.SaxParser.prototype.parseFile = function (filename) {
        var that = this;
        fs.readFile(filename, function (err, data) {
            that.parseString(data);
        });
    };
    exports.SaxParser.prototype.parseString = function (strD) {
        var that = this;
        var startnew = true;
        if (!that.m_parser) {
        ...
        if (!that.m_bErr && !startnew) {
            that._fireEvent(exports.SaxParser.DOC_B);
        }
        that._parseLoop();
        if (!that.m_bErr && !that.m_interrupted) {
            that._fireEvent(exports.SaxParser.DOC_E);
        }
        that.m_xml = null;
        that.m_iP = 0;
        that.m_interrupted = false;
    };
    exports.SaxParser.prototype.pause = function () {
        this.m_parser.pause();
    };
    exports.SaxParser.prototype.resume = function () {
    ...
    exports.SaxParser.prototype.setDocumentHandler = function (hnd) {
        this.m_hndDoc = hnd;
    };
    exports.SaxParser.prototype.setErrorHandler = function (hnd) {
        this.m_hndErr = hnd;
    };
    exports.SaxParser.prototype.setLexicalHandler = function (hnd) {
        this.m_hndLex = hnd;
    };
    exports.SaxParser.prototype.getColumnNumber = function () {
        return this.m_parser.getColumnNumber();
    };
    exports.SaxParser.prototype.getLineNumber = function () {
        return this.m_parser.getLineNumber();
    };
    exports.SaxParser.prototype.getMessage = function () {
        return this.m_strErrMsg;
    };
    exports.SaxParser.prototype.getPublicId = function () {
        return null;
    };
    exports.SaxParser.prototype.getSystemId = function () {
        return null;
    };
    exports.SaxParser.prototype.getLength = function () {
        return this.m_parser.getAttributeCount();
    };
    exports.SaxParser.prototype.getName = function (index) {
        return this.m_parser.getAttributeName(index);
    };
    exports.SaxParser.prototype.getValue = function (index) {
        return this.m_parser.getAttributeValue(index);
    };
    exports.SaxParser.prototype.getValueByName = function (name) {
        return this.m_parser.getAttributeValueByName(name);
    };
    exports.SaxParser.prototype._fireError = function (strMsg) {
    ...
    exports.SaxParser.prototype._fireEvent = function (iEvt) {
        var hnd, func, args = arguments, iLen = args.length - 1;
        if (this.m_bErr)
            return;
        if (exports.SaxParser.DOC_B == iEvt) {
            func = "onStartDocument";
            hnd = this.m_hndDoc;
        }
        else if (exports.SaxParser.DOC_E == iEvt) {
            func = "onEndDocument";
            hnd = this.m_hndDoc;
        }
        else if (exports.SaxParser.ELM_B == iEvt) {
            func = "onStartElementNS";
            hnd = this.m_hndDoc;
        }
        else if (exports.SaxParser.ELM_E == iEvt) {
            func = "onEndElementNS";
            hnd = this.m_hndDoc;
        }
        else if (exports.SaxParser.CHARS == iEvt) {
            func = "onCharacters";
            hnd = this.m_hndDoc;
        }
        else if (exports.SaxParser.PI == iEvt) {
            func = "processingInstruction";
            hnd = this.m_hndDoc;
        }
        else if (exports.SaxParser.CD_B == iEvt) {
            func = "onCdata";
            hnd = this.m_hndLex;
        }
        else if (exports.SaxParser.CD_E == iEvt) {
            func = "onEndCDATA";
            hnd = this.m_hndLex;
        }
        else if (exports.SaxParser.CMNT == iEvt) {
            func = "onComment";
            hnd = this.m_hndLex;
        }
        if (hnd && hnd[func]) {
    ...
    exports.SaxParser.prototype._parseLoop = function (parser) {
        var iEvent, parser, nameobject, theatts, theattsandnamespace;
        ...
        while (!this.m_bErr) {
            ...
            if (iEvent == XMLP._ELM_B) {
                ...
                this._fireEvent(exports.SaxParser.ELM_B, nameobject.name, theattsandnamespace[0], (nameobject.prefix === '') ? null : nameobject.prefix, (theuri === '') ? null : theuri, theattsandnamespace[1]);
            }
            else if (iEvent == XMLP._ELM_E) {
                nameobject = parser._parsePrefixAndElementName(parser.getName());
                var theuri = parser._getContextualNamespace(nameobject.prefix);
                parser._removeExpiredNamespaces(parser.getName());
                this._fireEvent(exports.SaxParser.ELM_E, nameobject.name, (nameobject.prefix === '') ? null : nameobject.prefix, (theuri === '') ? null : theuri);
            }
                ...
                theattsandnamespace = parser._parseNamespacesAndAtts(theatts);
                var theuri = parser._getContextualNamespace(nameobject.prefix);
                this._fireEvent(exports.SaxParser.ELM_B, nameobject.name, theattsandnamespace[0], (nameobject.prefix === '') ? null : nameobject.prefix, (theuri === '') ? null : theuri, theattsandnamespace[1], true);
                parser._removeExpiredNamespaces(parser.getName());
                this._fireEvent(exports.SaxParser.ELM_E, nameobject.name, (nameobject.prefix === '') ? null : nameobject.prefix, (theuri === '') ? null : theuri, true);
            }
            else if (iEvent == XMLP._TEXT) {
                this._fireEvent(exports.SaxParser.CHARS, parser.getContent().slice(parser.getContentBegin(), parser.getContentEnd()));
            }
            else if (iEvent == XMLP._ENTITY) {
                this._fireEvent(exports.SaxParser.CHARS, parser.getContent(), parser.getContentBegin(), parser.getContentEnd() - parser.getContentBegin());
            }
            else if (iEvent == XMLP._PI) {
                this._fireEvent(exports.SaxParser.PI, parser.getName(), parser.getContent().substring(parser.getContentBegin(), parser.getContentEnd()));
            }
            else if (iEvent == XMLP._CDATA) {
                this._fireEvent(exports.SaxParser.CD_B, parser.getContent().slice(parser.getContentBegin(), parser.getContentEnd()));
            }
            else if (iEvent == XMLP._COMMENT) {
                this._fireEvent(exports.SaxParser.CMNT, parser.getContent().slice(parser.getContentBegin(), parser.getContentEnd()));
            }
...
//# sourceMappingURL=node-xml.js.map